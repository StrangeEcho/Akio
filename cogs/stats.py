...
class Stats(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        embed = discord.Embed(title='Akio Stats', color=0xffb6c1)
        embed.set_author(name='Basics')
        embed.set_thumbnail(url=self.bot.user.avatar_url)
        embed.add_field(name='Mention:', value=self.bot.user.mention, inline=True)
        embed.add_field(name='Authors:', value='Tylerr#6979\nWi1dloli#5800', inline=True)
        ...
        for channel in self.bot.get_all_channels():
            ...
            if isinstance(channel, discord.VoiceChannel):
                voice_channels += 1
        embed2 = discord.Embed(title='Akio Stats', color=0xffb6c1)
        ...
        embed3 = discord.Embed(title='Akio Stats', color=0xffb6c1)
        embed3.set_author(name='Node Statistics')
